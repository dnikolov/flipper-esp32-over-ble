/* Split out of cbor_codec.h 2026-09-08 (docs/OPTIMIZATION.md item 1) -- included by the
   ...
   feb_cbor_status_t and the FEB_CBOR_MAX_ / FEB_SESSION_ID_LEN / FEB_GCM_TAG_LEN macros this
   header uses are already visible; not meant to be included standalone. Not part of the
   cross-firmware shared-header contract check (tools/check_shared_headers.py diffs
   cbor_codec.h itself, which still transitively provides everything declared here).
