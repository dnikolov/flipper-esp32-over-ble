/* Split out of cbor_codec.h (docs/OPTIMIZATION.md item 1) -- canonical-CBOR primitives,
   mirrored byte-for-byte in flipper/cbor_primitives.h. Changes here must be mirrored there
   and in docs/PROTOCOL.md, or the two firmwares diverge. Included transitively via
