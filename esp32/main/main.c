...
/* ceil(FEB_MAX_RECORD_SIZE / feb_fragment_capacity(FEB_FLIPPER_WRITE_EFFECTIVE_MTU)) =
   ...
   and negotiated_att_mtu stays at the pre-negotiation default of 23, capacity drops to
    ...
    case BLE_GAP_EVENT_DISCONNECT: {
        ...
        default:
            /* Plain link loss / idle timeout / graceful close -- reconnect promptly,
               ...
               active) keeps scanning at its own configured wardriving_wifi_interval_ms
